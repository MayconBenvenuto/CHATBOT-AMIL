  ...
  handler: async (_ctx, _args) => {
    try {
      ...
      const emailResult = await resend.emails.send({
        from: emailFrom,
        to: emailDestination,
        subject: "🧪 Teste de e-mail do Chatbot Amil Seguros PME",
        html: `
          <!DOCTYPE html>
          <html>
          <head>
            <meta charset="utf-8">
            <title>Teste de E-mail - Chatbot Amil Seguros PME</title>
            <style>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <p>Este é um e-mail de teste do Chatbot Amil Seguros PME.</p>
